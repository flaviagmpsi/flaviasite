...
export default function Projects() {
  return (
    <section id="projetos" className="py-32 md:py-40 px-6 md:px-10 bg-surface-base">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display text-[clamp(2rem,3vw,2.6rem)] font-light text-dark-warm tracking-[-0.02em] mb-5">
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="p-8 md:p-10">
              ...
              <h3 className="font-display text-[1.4rem] font-medium text-dark-warm mb-5 tracking-[-0.01em]">
                Associação Allos
              </h3>
              <p className="font-body text-[0.9rem] text-text-secondary font-light leading-[1.85] mb-5">
              ...
              <p className="font-body text-[0.9rem] text-text-secondary font-light leading-[1.85]">
